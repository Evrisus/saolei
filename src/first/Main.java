...
public class Main extends JFrame implements ActionListener, MouseListener {
	...
	// private static final int SNUM = 9;// 这个SUM是扫雷的格数，可以编写程序来改变
	private JButton[][] jb;
	private int[][] map;
	boolean[][] flags;
	boolean[][] flag;
	...
	public Main(int SNUM, int Mines) {// 主要界面构造函数
		...
		fileMenu1.add(JmiSave = new JMenuItem("排行榜"));
	...
	@Override
	public void actionPerformed(ActionEvent e) {//点击显示
		// TODO Auto-generated method stub
	...
	private void checkSuccess() {
		...
		if (count == NUM) {
			String uuid = UUID.randomUUID().toString().replaceAll("-", "");//表唯一表示uuid
